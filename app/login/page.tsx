      ...
      >
        ...
        <form onSubmit={handleSubmit} className="space-y-5">
          ...
          <motion.button
            ...
            disabled={loading}
            className="btn btn-secondary w-full justify-center gap-2 disabled:opacity-50 disabled:cursor-not-allowed"
            custom={3}
            variants={itemVariants}
            initial="hidden"
            animate="visible"
        ...
        {/* Footer Links */}
        <motion.div
          className="mt-8 space-y-4 border-t border-slate-800 pt-8"
          custom={4}
          variants={itemVariants}
          initial="hidden"
          animate="visible"
        >
          <div className="flex flex-col gap-3 sm:flex-row sm:justify-between">
            ...
            <Link href="/register" className="text-sm text-slate-400 hover:text-cyan-400 transition">
              Criar conta
            </Link>
          </div>
        </motion.div>
